...
import 'package:travel_flutter/utils/snacbar.dart';
...
class _EditProfileState extends State<EditProfile> {
  ...
  Future uploadPicture() async {
    ...
    uploadTask.then((snapshot) => {print('upload complete')});

    var _url = await storageReference.getDownloadURL();
    //var _url = await (await uploadTask.whenComplete).ref.getDownloadURL();
